...
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Cloves - Whole', 321.7, '5/2/2021', 15);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Apple - Northern Spy', 3483.35, '6/17/2021', 16);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Bacardi Breezer - Strawberry', 383.81, '7/31/2021', 17);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Arizona - Plum Green Tea', 2334.05, '2/18/2021', 18);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Bar Special K', 671.45, '6/22/2021', 19);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Appetizer - Smoked Salmon / Dill', 3191.63, '5/18/2021', 20);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Magnotta - Bel Paese White', 698.89, '6/10/2021', 20);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Shrimp - 16/20, Iqf, Shell On', 778.2, '3/22/2021', 20);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Hold Up Tool Storage Rack', 3637.77, '1/28/2021', 15);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Wine - Cotes Du Rhone Parallele', 1469.61, '4/2/2021', 21);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Cheese - Shred Cheddar / Mozza', 1155.33, '4/6/2021', 21);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Oranges - Navel, 72', 2979.93, '3/2/2021', 22);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Wine - Gato Negro Cabernet', 1220.27, '3/3/2021', 23);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Cheese - Feta', 1913.18, '5/6/2021', 23);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Oil - Olive', 3363.87, '5/10/2021', 23);
insert into PRODUCT (title, cost, MANUFACTURE_DATE, MANUFACTURER_ID) values ('Chicken Giblets', 4848.1, '9/18/2021', 24);
